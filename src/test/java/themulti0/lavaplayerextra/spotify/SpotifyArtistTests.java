...
public class SpotifyArtistTests {
    ...
    private static final Logger log = LoggerFactory.getLogger(SpotifyArtistTests.class);
    private static final String url = "https://open.spotify.com/album/27QEi5B54KmAjyZ9blP5yV";
    private final MultiThreadingOptions concurrentOperations = new MultiThreadingOptions(0, 1);
    ...
    public void testSourceManager() throws Exception {
        ...
        var item = spotifyManager.loadSpotifyItem(getManager(), url, 0, 0, concurrentOperations);
    ...
    public void testDirect() throws Exception {
        var artistProvider = new ArtistTopTracksProvider(LoadTestsHelper.getSpotifyFacade(), getManager());
        AudioPlaylist playlist = artistProvider.getCollection(url, concurrentOperations);
        playlist.getTracks().forEach(this::checkTrack);
    }
